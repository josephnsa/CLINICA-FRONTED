...
export function normalizeMenuRoute(route?: string | null): string | null {
  ...
  const aliases: Record<string, string> = {
    ...
    'atencion/contactos': 'atencion-cliente/reclamos',
    'atencion/no-shows': 'atencion-cliente/encuestas',
    ...
    'portal/reservas': 'portal/reserva',
    'portal/notificaciones': 'portal/confirmaciones',
